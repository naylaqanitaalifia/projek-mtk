  ...
  <style>
    ...
    <nav aria-label="breadcrumb">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <img src="img/card-2.png" alt="" class="img-fluid flex-end">
        </div>
    </nav>

    <div class="d-flex justify-content-center">
        <h5 class="text-start fw-bold">Use this calculator to calculate the final capital of a compound interest.</h5>
    </div>
            ...
            <div class="col-md-12">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["hitung"])) {
                    ...
                    if (!empty($modal) && !empty($bunga) && !empty($periode)) {
                        ...
                        $modalAkhir = $modal * pow((1 + $bunga), $periode);
                        echo "<div class='card-custom border rounded shadow-sm p-3'>The final amount from compound interest is <b>Rp" . number_format($modalAkhir, 2, ",", ".") . "</b> with interest amounting to <b>Rp" . number_format($hasil, 2, ",", ".") .  "</b> </div>";
                    } else {
